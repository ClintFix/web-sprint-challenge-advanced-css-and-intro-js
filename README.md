...
1. How would you describe acessibility on the web to someone new to programming? 
    Accessibility is designing a website in such a way that people with varying disabilities can use the site - by changing font scale, using screen readers, colors that readable for colorblind, etc. 
2. Talk about 3 different things you can do to ensure your website is accessible. 
    Use scalable units: rem, em, %
    Use break points
    Use semantic HTML
    Fill out alt tags
3. How would you explain the concept of a variable to someone new to programming?
    it is a descriptive container for data
4. What is the purpose of using functions in code?
    To keep it DRY. It allows you to reference chunks of code instead of having to re-write the logic.
